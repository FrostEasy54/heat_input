...
class MyGUI(QMainWindow, RoomsTable, PeopleTable, EquipmentTable, LampsTable):
    ...
    def __init__(self):
        ...
        self.SeasonComboBox.currentTextChanged.connect(
            self.UpdateRoomInnerTempMinMax)
        ...
        # Добавление и удаление новых рядов для таблицы Освещение
        ...
        # Установка виджетов для таблицы Освещение
        ...
        # Расчёт теплопоступлений от Светильников на листе Освещение
    ...
    def SetWindSpeed(self):
        if self.SeasonComboBox.currentText() == "Теплый":
            ...
            self.WindSpeedDoubleSpinBox.setMinimum(0.01)
    ...
    def ExportSingleTable(self, export_function):
        ...
        QMessageBox.information(
            self, "Успешно", "Таблица успешно сохранена в файл: {}".format(path))  # noqa E501
    ...
    def ExportAllTables(self):
        ...
        wb.save(path)
        QMessageBox.information(
            self, "Успешно", "Все таблицы успешно сохранены в файл: {}".format(path))  # noqa E501
    ...
    def ImportSingleTable(self, import_function):
        ...
        try:
            ...
            QMessageBox.critical(
                self, "Ошибка", f"Произошла ошибка при открытии файла: {str(e)}")  # noqa E501
